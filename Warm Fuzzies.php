...
$check_avail = "SELECT * FROM restaurant_list WHERE Name = 'Warm Fuzzies' AND avl = 1"; // Search for items in the product_list that includes the restaurant name "Warm Fuzzies"
...
<!-- END OF CART  -->   
    ...
    <?php
     $sql="SELECT * FROM restaurant_list WHERE Name = 'Warm Fuzzies'";
    ...
    <header class="pb-3 mb-4 border-bottom">
      <a href="#" class="d-flex align-items-center text-dark text-decoration-none">
        ...
        <span class="fs-2">Warm Fuzzies</span> <!-- Stall Name -->
    ...
    <?php
      ...
      include ('db_conn.php'); 
              $qry = $con->query("SELECT * FROM  product_list WHERE restaurant = 'Warm Fuzzies' AND category='$category' AND avl='1' order by product_id ASC"); // Search for items in the product_list that includes the restaurant name "Warm Fuzzies"
      ...
      ?>
          ...
          <!-- END OF PRODUCT CARD  -->         
            ...
            <!-- ADD TO CART FORM -->
                    ...
                    <input type="number" name = "qty" value="1" min = 1 max = "<?php echo $row['stock'] ?>" class="form-control text-center qty-input<?php echo $row['product_id'] ?>" >  <!-- Quantity value-->
