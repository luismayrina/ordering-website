...
<!-- END OF CART  -->   
    ...
    <div class=" hero-carousel__cell--1">
     <img src="assets/images/banner_waffletime.JPG" style = "max-height: 300px;" id = "banner" class="hero-carousel__cell d-block w-100" alt="...">
    ...
    <header class="pb-3 mb-4 border-bottom">
      <a href="#" class="d-flex align-items-center text-dark text-decoration-none">
        ...
        <span class="fs-2">Waffle Time</span> <!-- Stall Name -->
    ...
    <?php
      ...
      include ('db_conn.php'); 
              $qry = $con->query("SELECT * FROM  product_list WHERE restaurant = 'Waffle Time' AND category='$category' order by product_id ASC"); // Search for items in the product_list that includes the restaurant name "Waffle Time"
      ...
      ?>
          ...
          <!-- PRODUCT Image -->
                      <div>
                        ...
                        <?php $product_stock = $row['stock'];
                        $avl = $row['avl'];
                        if ($product_stock || $avl == 0){ 
          ...
          <!-- END OF PRODUCT CARD  -->         
            ...
            <!-- ADD TO CART FORM -->
                    ...
                    <input type="number" name = "qty" value="1" min = 1  class="form-control text-center qty-input<?php echo $row['product_id'] ?>" >  <!-- Quantity value-->
