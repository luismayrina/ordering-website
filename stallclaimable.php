<?php
    ...
    if (isset($_SESSION['ID']) && isset($_SESSION['User'])){
		if ($_SESSION['User'] == "turksadmin" || $_SESSION['User'] == "waffleadmin"){
            ...
            $sql="SELECT * FROM order_list WHERE restaurant_name = '$res' AND status = 'Claimable'";
...
<html lang = "en">
    ...
    <div class="navbar">
      ...
      <a class="activenav" href="stallclaimable.php">Claimable Orders</a>
                ...
                <div class="header">
                    ...
                    <div class="order-2 bg-success">
                        <div class="p-4 serving text-center">
                            <h4> <?php echo $res; ?> Claimable Orders</h4>
                            ...
                            <div class="grid-container">
                               ...
                               <div style="text-align:center;" class="grid-item" >
                                    <div class="mypad">
                                        ...
                                        <div><a href="claimable.php?claimid=<?php echo $rowid["order_id"];?>" onclick='return checkdelete2()'><button class="button114">CLAIMED</button></a> 
                                        </div>
                                        <a href="orderdone.php?doneid=<?php echo $rowid["order_id"];?>" onclick='return checkdelete()'><button class="button115">REMOVE</button></a>
