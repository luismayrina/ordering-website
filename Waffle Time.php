...
$check_avail = "SELECT * FROM restaurant_list WHERE Name = 'Waffle Time' AND avl = 1"; // Search for items in the product_list that includes the restaurant name "Waffle Time"
...
<!-- END OF CART  -->   
    ...
    <?php
     $sql="SELECT * FROM restaurant_list WHERE Name = 'Waffle Time'";
    ...
    <?php
      ...
      include ('db_conn.php'); 
              $qry = $con->query("SELECT * FROM  product_list WHERE restaurant = 'Waffle Time' AND category='$category' AND avl='1' order by product_id ASC"); // Search for items in the product_list that includes the restaurant name "Waffle Time"
