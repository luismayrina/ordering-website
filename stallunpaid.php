<?php
    ...
    if (isset($_SESSION['ID']) && isset($_SESSION['User'])){
		if ($_SESSION['User'] == "turksadmin" || $_SESSION['User'] == "waffleadmin"){
            ...
            $sql="SELECT * FROM order_list WHERE restaurant_name = '$res' AND status = 'Pending'";
...
<html lang = "en">
    ...
    <div class="navbar">
	  ...
	  <a class="activenav" href="stallunpaid.php">Orders to Pay</a>
                ...
                <div class="header">
                    ...
                    <div class="order-2 bg-success">
                        <div class="p-4 serving text-center">
                            <h4> <?php echo $res; ?> To Pay Orders</h4>
                            ...
                            <div class="grid-container">
                                ...
                                <div style="text-align:center;" class="grid-item" >
                                    <div class="mypad">
                                        ...
                                        <div><h5 style="color:black;">Order No: <?php echo $rowid["order_id"]; ?></h5></div>
                                        <div><h6 style="color:black;"><?php echo $rowid["User"]; ?></h6></div>
