...
$check_avail = "SELECT * FROM restaurant_list WHERE Name = 'House of Dimsum' AND avl = 1"; // Search for items in the product_list that includes the restaurant name "House of Dimsum"
...
<!-- END OF CART  -->   
    ...
    <?php
     $sql="SELECT * FROM restaurant_list WHERE Name = 'House of Dimsum'";
    ...
    <header class="pb-3 mb-4 border-bottom">
      <a href="#" class="d-flex align-items-center text-dark text-decoration-none">
        ...
        <span class="fs-2">House of Dimsum</span> <!-- Stall Name -->
    ...
    <?php
      ...
      include ('db_conn.php'); 
              $qry = $con->query("SELECT * FROM  product_list WHERE restaurant = 'House of Dimsum' AND category='$category' AND avl='1' order by product_id ASC"); // Search for items in the product_list that includes the restaurant name "House of Dimsum"
