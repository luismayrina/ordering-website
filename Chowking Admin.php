...
<body>
	...
	<p style="text-align:center; font-family:Times New Romans; font-size:72"><strong>Chowking</strong><p>
	</header>
	</div>
			...
			<div class="mycolumn myright">
						<button class="open-button text1" onclick="openForm()">+</button>
							<div class="form-popup" id="myForm">
								<form action="Chowking Admin.php" method="POST" class="form-container" enctype="multipart/form-data">
								<h1>Add Food</h1>
								...
								<input type="text" placeholder="Enter restaurant name" value="Chowking" name="restaurant" id="restaurant" required>
								...
								<div class="myrow">
									<div class="mycolumn myleft50">
										...
										<input type="number" placeholder="Enter stocks" name="stock" id="stock" required>
									</div>
					...
					<?php include_once 'Chowking Display.php' ?>	  	
			</div>
