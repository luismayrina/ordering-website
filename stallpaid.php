<?php
    ...
    if (isset($_SESSION['ID']) && isset($_SESSION['User'])){
		if ($_SESSION['User'] == "turksadmin" || $_SESSION['User'] == "waffleadmin"){
            ...
            $sql="SELECT * FROM order_list WHERE restaurant_name = '$res' AND status = 'Paid'";
...
<html lang = "en">
    ...
    <div class="navbar">
	  ...
	  <a class="activenav" href="stallpaid.php">Pending Orders</a>
                ...
                <div class="header">
                    ...
                    <div class="order-2 bg-success">
                        <div class="p-4 serving text-center">
                            <h4> <?php echo $res; ?> Pending Orders</h4>
                            ...
                            <div class="grid-container">
                               ...
                               <div style="text-align:center;" class="grid-item" >
                                    <div class="mypad">
                                        ...
                                        <a href="finishedorder.php?finishid=<?php echo $rowid["order_id"];?>" onclick='return checkdelete()'><button class="button14">DONE</button></a>   									
                                </div>
                                <?php }}}
                                } ?>
		</div>
