...
<body>
	...
	<p style="text-align:center; font-family:Times New Romans; font-size:72"><strong>Turks</strong><p>
	</header>
	</div>
			...
			<div class="mycolumn myright">
						<button class="open-button text1" onclick="openForm()">+</button>
							<div class="form-popup" id="myForm">
								<form action="Turks Admin.php" method="POST" class="form-container" enctype="multipart/form-data">
								<h1>Add Food</h1>
								...
								<input type="text" placeholder="Enter restaurant name" value="Turks" name="restaurant" id="restaurant" required>
					...
					<?php include_once 'Turks Display.php' ?>	  	
			</div>
