...
$check_avail = "SELECT * FROM restaurant_list WHERE Name = 'Chowking' AND avl = 1"; // Search for items in the product_list that includes the restaurant name "Chowking"
...
<!-- END OF CART  -->   
    ...
    <?php
     $sql="SELECT * FROM restaurant_list WHERE Name = 'Chowking'";
    ...
    <header class="pb-3 mb-4 border-bottom">
      <a href="#" class="d-flex align-items-center text-dark text-decoration-none">
        ...
        <span class="fs-2">Chowking</span> <!-- Stall Name -->
    ...
    <?php
      ...
      include ('db_conn.php'); 
              $qry = $con->query("SELECT * FROM  product_list WHERE restaurant = 'Chowking' AND category='$category' AND avl='1' order by product_id ASC"); // Search for items in the product_list that includes the restaurant name "Chowking"
