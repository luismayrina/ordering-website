...
$check_avail = "SELECT * FROM restaurant_list WHERE Name = 'Ava Cakery' AND avl = 1"; // Search for items in the product_list that includes the restaurant name "Ava Cakery"
...
<!-- END OF CART  -->   
    ...
    <?php
     $sql="SELECT * FROM restaurant_list WHERE Name = 'Ava Cakery'";
    ...
    <header class="pb-3 mb-4 border-bottom">
      <a href="#" class="d-flex align-items-center text-dark text-decoration-none">
        ...
        <span class="fs-2">Ava Cakery</span> <!-- Stall Name -->
    ...
    <?php
      ...
      include ('db_conn.php'); 
              $qry = $con->query("SELECT * FROM  product_list WHERE restaurant = 'Ava Cakery' AND category='$category' AND avl='1' order by product_id ASC"); // Search for items in the product_list that includes the restaurant name "Ava Cakery"
